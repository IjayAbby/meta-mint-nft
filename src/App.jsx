...
function App() {
    ...
    const address= String(myContractAddress).toLowerCase();
                            ...
                            {myTokensData.length === 0 ? (
                                ...
                                myTokensData.map((x,index) => (
                                    <Box key={x.dna} className="w-[20rem]">
                                        ...
                                        <Button className="px-8 py-2 text-xl mt-2 mx-2">
                                            Mint
                                        </Button>
                                        <Button className="px-8 py-2 text-xl mt-2 mx-2">
                                            <a href={`https://testnets.opensea.io/assets/mumbai/${address}/${index}`}>
                                            View on Opensea
                                            </a>
                                        </Button>
